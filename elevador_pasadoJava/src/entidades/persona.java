...
public class Persona {
    ...
    private static int cuentaPersonas = 0; // n�mero total de gente
    private int ID; // N�mero de ID �nico de la persona
    private int pisoDestino; // n�mero de piso de destino
